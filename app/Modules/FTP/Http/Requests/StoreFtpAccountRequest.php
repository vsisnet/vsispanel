...
class StoreFtpAccountRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'username' => [
                ...
                'unique:ftp_accounts,username',
            ],
            'password' => ['required', 'string', 'min:8', 'max:128'],
            'home_directory' => ['nullable', 'string', 'max:255'],
            'status' => ['nullable', 'string', Rule::in(FtpAccount::getStatuses())],
            'quota_mb' => ['nullable', 'integer', 'min:0', 'max:10485760'], // Max 10TB
            'bandwidth_mb' => ['nullable', 'integer', 'min:0'],
            'upload_bandwidth_kbps' => ['nullable', 'integer', 'min:0', 'max:1048576'], // Max 1Gbps
